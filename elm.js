...
Elm.Main.make = function (_elm) {
   ...
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $MapEditor = Elm.MapEditor.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $View = Elm.View.make(_elm);
   var filterBy = F3(function (decider,
   $default,
   sig) {
      return $Signal.map($Basics.snd)(A2($Signal.filter,
      $Basics.fst,
      {ctor: "_Tuple2"
      ,_0: true
      ,_1: $default})($Signal.sampleOn(sig)(A3($Signal.map2,
      F2(function (v0,v1) {
         return {ctor: "_Tuple2"
                ,_0: v0
                ,_1: v1};
      ...
      return function () {
         ...
         m) {
            return function () {
               switch (a.ctor)
               {case "Just":
                  return A2(config.update,a._0,m);
         ...
         actions.address,
         $Maybe.Just);
         var sig = $Signal.mergeMany(A2($List._op["::"],
         actions.signal,
         A2($List.map,
   ...
   var DnDDrop = F2(function (a,
   b) {
      return {ctor: "DnDDrop"
             ,_0: a
             ,_1: b};
   });
   var DnDDrag = F2(function (a,
   b) {
      return {ctor: "DnDDrag"
             ,_0: a
             ,_1: b};
   });
   var DnDNoEvent = {ctor: "DnDNoEvent"};
   var toDnDEventSignal = F2(function (mouse,
   target) {
      return function () {
         var difference = F2(function (_v2,
         _v3) {
            return function () {
               switch (_v3.ctor)
               {case "_Tuple2":
                  return function () {
                       ...
                       {case "_Tuple2":
                          return {ctor: "_Tuple2"
                                 ...
                                 ,_1: _v2._1 - _v3._1};}
                       _U.badCase($moduleName,
                       "on line 91, column 41 to 57");
                    }();}
               _U.badCase($moduleName,
               "on line 91, column 41 to 57");
            }();
         });
         var toDnD = F2(function (_v10,
         _v11) {
            return function () {
               switch (_v11.ctor)
               {case "_Tuple2":
                       ...
                       {case "_Tuple2":
                          return function () {
                               var _v18 = {ctor: "_Tuple3"
                                          ,_0: _v11._0
                                          ,_1: _v10._0.eventType
                                          ,_2: _v10._1};
                               switch (_v18.ctor)
                               {case "_Tuple3":
                                  switch (_v18._0.ctor)
                                    {case "Just": switch (_v18._1)
                                         {case "mousemove":
                                            switch (_v18._2.ctor)
                                              {case "Just":
                                                 return {ctor: "_Tuple2"
                                                        ,_0: $Maybe.Just(_v18._0._0)
                                                        ,_1: A2(DnDDrag,
                                                        _v18._2._0,
                                                        A2(difference,
                                                        _v10._0.position,
                                            ...
                                            switch (_v18._2.ctor)
                                              ...
                                              break;}
                                         break;
                                       case "Nothing": switch (_v18._1)
                                         {case "mousedown":
                                            switch (_v18._2.ctor)
                                              {case "Just":
                                                 return {ctor: "_Tuple2"
                                                        ,_0: $Maybe.Just(_v10._0.position)
                                                        ,_1: A2(DnDDrag,
                                                        _v18._2._0,
                                                        {ctor: "_Tuple2"
                                                        ,_0: 0
         ...
         mouse,
         target));
         return $Signal.map($Basics.snd)(A2($Signal.foldp,
         toDnD,
         {ctor: "_Tuple2"
         ,_0: $Maybe.Nothing
         ,_1: DnDNoEvent})(sig));
   ...
   var toMoveSignal = F2(function (modeInput,
   mouseInput) {
      return function () {
         var decider = A2($Signal.map,
         F2(function (x,y) {
            return _U.eq(x,y);
         })($View.InputModeMove),
         modeInput);
         var mouseInput$ = A2(filterBy,
         decider,
         {_: {}
         ,eventType: "noevent"
         ...
         var selectSig = function () {
            ...
            prev) {
               return function () {
                  return function () {
                     var _v28 = _v26.eventType;
                     switch (_v28)
                     {case "mousedown":
                        return $Maybe.Just({ctor: "_Tuple2"
                                           ,_0: $Basics.fst(_v26.position) / $View.tileSize | 0
                                           ,_1: $Basics.snd(_v26.position) / $View.tileSize | 0});}
                     return prev;
                  }();
               }();
            });
         ...
         var dndSig = A2(toDnDEventSignal,
         mouseInput$,
         selectSig);
         var dragSig = A2($Basics.flip,
         $Signal.map,
         dndSig)(function (e) {
            return function () {
               switch (e.ctor)
         ...
         var toAppInput = function (dnd) {
            return function () {
               switch (dnd.ctor)
               {case "DnDDrop":
                  return $Maybe.Just(A2($MapEditor.Move,
                    dnd._0,
                    {ctor: "_Tuple2"
                    ,_0: $Basics.fst(dnd._1) / $View.tileSize | 0
                    ,_1: $Basics.snd(dnd._1) / $View.tileSize | 0}));}
               return $Maybe.Nothing;
            }();
         };
         var moveSig = A2($Signal.filterMap,
         $Basics.identity,
         A2($MapEditor.PutTile,
         0,
         {ctor: "_Tuple2"
         ,_0: 0
         ,_1: 0}))(A2($Signal.map,
   ...
   var toPutTileSignal = F3(function (modeInput,
   tileInput,
   mouseInput) {
      return function () {
         var decider = A2($Signal.map,
         ...
         ,position: {ctor: "_Tuple2"
                    ,_0: 0
                    ,_1: 0}})(A2($Signal.filter,
         function (me) {
            return _U.eq(me.eventType,
            "mousedown");
         },
         {_: {}
         ,eventType: "noevent"
         ,position: {ctor: "_Tuple2"
                    ,_0: 0
                    ,_1: 0}})(mouseInput));
         var toAppInput = function (_v35) {
            return function () {
               switch (_v35.ctor)
               {case "_Tuple2":
                  return function () {
                       var $ = _v35._1.position,
                       x = $._0,
                       y = $._1;
                       var x$ = x / $View.tileSize | 0;
                       var y$ = y / $View.tileSize | 0;
                       return A2($MapEditor.PutTile,
                       _v35._0,
                       {ctor: "_Tuple2"
                       ,_0: x$
                       ,_1: y$});
         ...
         return $Signal.map(toAppInput)(A2($Signal.sampleOn,
         mouseInput$,
         A3($Signal.map2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
   ...
   var mapMouseInput = Elm.Native.Port.make(_elm).inboundSignal("mapMouseInput",
   "Main.MouseEvent",
   function (v) {
      return typeof v === "object" && "eventType" in v && "position" in v ? {_: {}
                                                                            ,eventType: typeof v.eventType === "string" || typeof v.eventType === "object" && v.eventType instanceof String ? v.eventType : _U.badPort("a string",
                                                                            v.eventType)
                                                                            ...
                                                                            v.position)} : _U.badPort("an object with fields `eventType`, `position`",
      v);
   });
   var MouseEvent = F2(function (a,
   b) {
      return {_: {}
             ,eventType: a
             ,position: b};
   ...
   var main = function () {
      var modeMb = $Signal.mailbox($View.InputModePutTile);
      var $ = A2(toMoveSignal,
      modeMb.signal,
      mapMouseInput),
      moveSig = $._0,
      dragSig = $._1;
      var tileMb = $Signal.mailbox(0);
      var putTileSig = A3(toPutTileSignal,
      modeMb.signal,
      tileMb.signal,
      mapMouseInput);
      var sig = A2($Signal.merge,
      putTileSig,
      moveSig);
      var initialMap = $Array.repeat($MapEditor.initialMapHeight)(A2($Array.repeat,
      $MapEditor.initialMapWidth,
      0));
      var initial = {_: {}
                    ,map: initialMap};
      return start({_: {}
                   ,initial: initial
                   ,inputs: _L.fromArray([sig])
                   ,update: $MapEditor.update
                   ,view: A3($View.view,
                   tileMb,
                   modeMb,
                   dragSig)});
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,toPutTileSignal: toPutTileSignal
                      ,toMoveSignal: toMoveSignal
                      ,DnDNoEvent: DnDNoEvent
                      ,DnDDrag: DnDDrag
                      ,DnDDrop: DnDDrop
                      ,toDnDEventSignal: toDnDEventSignal
                      ,App: App
                      ,start: start
                      ,filterBy: filterBy};
   return _elm.Main.values;
};
Elm.MapEditor = Elm.MapEditor || {};
Elm.MapEditor.make = function (_elm) {
   "use strict";
   _elm.MapEditor = _elm.MapEditor || {};
   if (_elm.MapEditor.values)
   return _elm.MapEditor.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "MapEditor",
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var getFromMat = F2(function (_v0,
   m) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
   ...
   var resizeMat = F4(function (w,
   h,
   x,
   m) {
      return function () {
         var emptyRow = A2($Array.repeat,
         w,
         x);
         var resize = F3(function (size,
         x,
         a) {
            return function () {
               var size0 = $Array.length(a);
               return _U.cmp(size,
               size0) > 0 ? A2($Array.append,
               a,
               A2($Array.repeat,
               size - size0,
               x)) : _U.cmp(size,
               size0) < 0 ? A3($Array.slice,
               0,
               size,
               a) : a;
            }();
         ...
         return A2(resize,
         h,
         emptyRow)($Array.map(A2(resize,
         w,
         x))(m));
      }();
   });
   var initializeMat = F3(function (w,
   h,
   x) {
      return $Array.repeat(h)(A2($Array.repeat,
      w,
      x));
   });
   var ResizeMap = function (a) {
      return {ctor: "ResizeMap"
             ,_0: a};
   };
                    ...
                    switch (input._1.ctor)
                      {case "_Tuple2":
                         return !_U.eq({ctor: "_Tuple2"
                           ...
                           {ctor: "_Tuple2"
                           ,_0: input._1._0
                           ,_1: input._1._1}) ? $Maybe.withDefault({_: {}
                                                                   ,map: _v12.map})($Maybe.map(function (m) {
                              return {_: {}
                                     ,map: A3(updateMat,
                                     {ctor: "_Tuple2"
                                     ,_0: input._0._0
   ...
   var initialMapHeight = 16;
   var initialMapWidth = 16;
   _elm.MapEditor.values = {_op: _op
                           ,initialMapWidth: initialMapWidth
                           ,initialMapHeight: initialMapHeight
...
Elm.View.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var classTile = $Html$Attributes.$class("tile");
   var classPaletteElement = $Html$Attributes.$class("palette-element");
   var classPalette = $Html$Attributes.$class("palette");
   var classControls = $Html$Attributes.$class("controls");
   var classControlGroup = $Html$Attributes.$class("control-group");
   var classControlContainer = $Html$Attributes.$class("control-container");
   var classOutput = $Html$Attributes.$class("output");
   var classMap = $Html$Attributes.$class("map");
   var classApp = $Html$Attributes.$class("app");
   var outputView = function () {
      var outputViewF = function (_v0) {
         return function () {
            return function () {
               var encodeRow = A2($Array.foldl,
               F2(function (a,b) {
               ...
               "")($Array.map(encodeRow)(_v0.map)));
               return A2($Html.textarea,
               _L.fromArray([classOutput
                            ,$Html$Attributes.readonly(true)]),
               _L.fromArray([$Html.text(encoded)]));
            }();
         }();
      };
      return $Signal.constant(outputViewF);
   }();
   var inputView = F3(function (value,
   toAction,
   address) {
      return function () {
         var clickEventDecoder = A2($Json$Decode.andThen,
         $Html$Events.targetValue,
         function (a) {
            return function () {
               var _v2 = $String.toInt(a);
               switch (_v2.ctor)
               {case "Err":
                  return $Json$Decode.fail(_v2._0);
                  case "Ok":
                  return $Json$Decode.succeed(toAction(_v2._0));}
               _U.badCase($moduleName,
               "between lines 90 and 94");
            }();
         });
         var onClick = A3($Html$Events.on,
         "click",
         clickEventDecoder,
         $Signal.message(address));
         var enterEventDecoder = A2($Json$Decode.andThen,
            ...
            return function () {
               ...
               {case "_Tuple2":
                  return function () {
                       var _v9 = {ctor: "_Tuple2"
                                 ,_0: _v5._0
                                 ,_1: $String.toInt(_v5._1)};
                       switch (_v9.ctor)
                       {case "_Tuple2": switch (_v9._0)
                            {case 13: switch (_v9._1.ctor)
                                 {case "Ok":
                                    return $Json$Decode.succeed(toAction(_v9._1._0));}
                                 break;}
                            switch (_v9._1.ctor)
                            {case "Err":
                               return $Json$Decode.fail(_v9._1._0);}
                            break;}
                       _U.badCase($moduleName,
         ...
         _L.fromArray([$Html$Attributes.type$("number")
                      ,onEnter
                      ,onClick
                      ,$Html$Attributes.value($Basics.toString(value))]),
         _L.fromArray([]));
         return A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([widthInput]));
      }();
   });
   var paletteColors = $Array.fromList(_L.fromArray([$Color.white
                                                    ,$Color.red
                                                    ,$Color.orange
                                                    ,$Color.yellow
                                                    ,$Color.green
                                                    ...
                                                    ,$Color.purple
                                                    ,$Color.brown]));
   var getPaletteColor = function (i) {
      return $Maybe.withDefault($Color.white)($Array.get(i)(paletteColors));
   };
   var InputModeMove = {ctor: "InputModeMove"};
   var InputModePutTile = {ctor: "InputModePutTile"};
   var modeView = function (_v14) {
      return function () {
         return function () {
                  ...
                  {case "_Tuple3":
                     return A2($Html.div,
                       ...
                       _L.fromArray([A2($Html.input,
                                    _L.fromArray([$Html$Attributes.id(_v18._1)
                                                 ,$Html$Attributes.type$("radio")
                                                 ,$Html$Attributes.checked(_U.eq(_v18._0,
                                                 mode))
                                                 ,onChange(_v18._0)]),
                                    _L.fromArray([]))
                                    ,A2($Html.label,
                                    _L.fromArray([$Html$Attributes.$for(_v18._1)]),
                                    _L.fromArray([$Html.text(_v18._2)]))]));}
                  _U.badCase($moduleName,
                  "between lines 65 and 68");
               }();
            });
            var modeViewF = function (mode) {
               return $Html.div(_L.fromArray([]))(A2($List.map,
               radio(mode),
               _L.fromArray([{ctor: "_Tuple3"
                             ,_0: InputModePutTile
                             ,_1: "input_mode_put_tile"
                             ,_2: "put tile"}
                            ,{ctor: "_Tuple3"
                             ,_0: InputModeMove
                             ,_1: "input_mode_move"
   ...
   var tileSize = 20;
   var tileColorView = $Signal.map(function ($) {
      return $Html.div(_L.fromArray([classTile]))(A2($Basics.flip,
      F2(function (x,y) {
         return A2($List._op["::"],
         x,
         y);
      ...
      tileSize,
      tileSize)(A2($Basics.flip,
      F2(function (x,y) {
         return A2($List._op["::"],
         x,
         y);
      }),
      _L.fromArray([]))(A2($Basics.flip,
      $Graphics$Collage.filled,
      $Graphics$Collage.square($Basics.toFloat(tileSize)))(getPaletteColor($)))))));
   });
   var palette = $Array.toList($Array.map(A2($Basics.flip,
   $Graphics$Collage.filled,
   $Graphics$Collage.square($Basics.toFloat(tileSize))))(paletteColors));
   var paletteView = function (address) {
      return function () {
         var toHtml = F2(function (i,
         form) {
            return A2($Html.div,
            _L.fromArray([classPaletteElement
         ...
         return $Html.div(_L.fromArray([classPalette]))(A2($List.indexedMap,
         toHtml,
         palette));
      }();
   };
   var controlView = F3(function (tileMb,
   modeMb,
   address) {
      return function () {
         var controlViewF = F3(function (tileColorV,
         modeV,
         _v23) {
            return function () {
               return function () {
                  var group = F2(function (label,
                  a) {
                     return A2($Html.div,
                     _L.fromArray([classControlGroup]),
                     _L.fromArray([A2($Html.label,
                                  _L.fromArray([]),
                                  _L.fromArray([$Html.text(label)]))
                                  ,a]));
                  });
                  var mapHeight = $Array.length(_v23.map);
                  var changeWidth = function (w) {
                     return $MapEditor.ResizeMap({ctor: "_Tuple2"
                                                 ,_0: w
                                                 ,_1: mapHeight});
                  };
                  var mapWidth = $Array.length($Maybe.withDefault($Array.empty)($Array.get(0)(_v23.map)));
                  ...
                  return A2($Html.div,
                  _L.fromArray([classControlContainer]),
                  _L.fromArray([group("tiles")(paletteView(tileMb.address))
                               ,group("tile")(tileColorV)
                               ,group("width")(A3(inputView,
                               mapWidth,
                               changeWidth,
                               address))
                               ,group("height")(A3(inputView,
                               mapHeight,
                               changeHeight,
                               address))
                               ,group("mode")(modeV)]));
         ...
         controlViewF,
         tileColorView(tileMb.signal),
         modeView(modeMb));
      }();
   });
   var mapView = F2(function (address,
   dragSig) {
      return function () {
         var mapViewF = F2(function (drag,
         _v25) {
            return function () {
               return function () {
                  var toForm = function ($) {
                  ...
                  var map$ = function () {
                     ...
                     {case "Just":
                        switch (drag._0.ctor)
                          {case "_Tuple2":
                             switch (drag._0._0.ctor)
                               {case "_Tuple2":
                                  return A3($MapEditor.updateMat,
                                    {ctor: "_Tuple2"
                                    ,_0: drag._0._0._0
                                    ,_1: drag._0._0._1},
                                    0,
                  ...
                  var mapHeight = $Array.length(_v25.map);
                  var h = mapHeight * tileSize;
                  var mapWidth = $Array.length($Maybe.withDefault($Array.empty)($Array.get(0)(_v25.map)));
                  ...
                  ox = $._0,
                  oy = $._1;
                  var moveForm = F2(function (x,
                  y) {
                     return $Graphics$Collage.move({ctor: "_Tuple2"
                                                   ,_0: $Basics.toFloat(ox + x)
                                                   ,_1: $Basics.toFloat(oy - y)});
                  });
                  var toFormAt = F2(function (x,
                  y) {
                     return function ($) {
                        return A2(moveForm,
                        x,
                  ...
                  var forms = $List.concat($Array.toList($Array.indexedMap(F2(function (j,
                  col) {
                     return $Array.toList($Array.indexedMap(F2(function (i,
                     row) {
                        return A3(toFormAt$,i,j,row);
                     }))(col));
                  }))(map$)));
                  var addDragForm = F2(function (_v33,
                  c) {
                     return function () {
                        switch (_v33.ctor)
                        {case "_Tuple2":
                           switch (_v33._0.ctor)
                             {case "_Tuple2":
                                switch (_v33._1.ctor)
                                  {case "_Tuple2":
                                     return function () {
                                          var dragOutline = $Graphics$Collage.outlined($Graphics$Collage.dashed($Color.black))($Graphics$Collage.square($Basics.toFloat(tileSize)));
                                          var y$ = _v33._0._1 * tileSize + _v33._1._1;
                                          var x$ = _v33._0._0 * tileSize + _v33._1._0;
                                          return A2($List.append,
                                          forms,
                                          _L.fromArray([A3(toFormAt,
                                                       x$,
                                                       y$,
                                                       c)
                                                       ,A2(moveForm,
                  ...
                  var forms$ = function () {
                     ...
                     {case "Just":
                        switch (drag._0.ctor)
                          {case "_Tuple2":
                             return $Maybe.withDefault(forms)($Maybe.map(addDragForm({ctor: "_Tuple2"
                                                                                     ,_0: drag._0._0
                                                                                     ,_1: drag._0._1}))(A2($MapEditor.getFromMat,
                               drag._0._0,
                               _v25.map)));}
                          break;
                  ...
                  return $Html.div(_L.fromArray([classMap
                                                ,$Html$Attributes.id("map-view")]))(A2($Basics.flip,
                  F2(function (x,y) {
                     return A2($List._op["::"],
                     x,
                     y);
   ...
   var view = F4(function (tileMb,
   modeMb,
   dragSig,
   address) {
      return function () {
         var combineApp = F4(function (mapViewF,
         controlViewF,
         outputViewF,
         map) {
            return A2($Html.div,
            _L.fromArray([classApp]),
            _L.fromArray([mapViewF(map)
                         ,controlViewF(map)
                         ,outputViewF(map)]));
         });
         return A4($Signal.map3,
         combineApp,
         A2(mapView,address,dragSig),
         A3(controlView,
         tileMb,
         modeMb,
         address),
   ...
   _elm.View.values = {_op: _op
                      ,tileSize: tileSize
                      ,InputModePutTile: InputModePutTile
                      ,InputModeMove: InputModeMove
                      ,paletteColors: paletteColors
                      ,getPaletteColor: getPaletteColor
                      ,paletteView: paletteView
                      ,tileColorView: tileColorView
                      ,modeView: modeView
                      ,palette: palette
                      ,inputView: inputView
                      ,view: view
                      ...
                      ,classControlContainer: classControlContainer
                      ,classControlGroup: classControlGroup
                      ,classControls: classControls
                      ,classPalette: classPalette
                      ,classPaletteElement: classPaletteElement
                      ,classTile: classTile};
   return _elm.View.values;
};
